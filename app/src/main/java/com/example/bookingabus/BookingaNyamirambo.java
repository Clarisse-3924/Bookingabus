...
public class BookingaNyamirambo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bookinga_nyamirambo);
...
//        Destination = (EditText) findViewById(R.id.room);
        ...
        Date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(BookingaNyamirambo.this,
        ...
        Time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(BookingaNyamirambo.this,
                        new TimePickerDialog.OnTimeSetListener() {
                            ...
                            public void onTimeSet(TimePicker view, int hourOfDay,
                                ...
                                if((hourOfDay <= (c.get(Calendar.HOUR_OF_DAY)))&&
                                    ...
                                    Toast.makeText(BookingaNyamirambo.this, "You can't pick a previous hour",
...
//                }
    ...
    private void makePayment(){
        String name = Name.getText().toString().trim();
        String email = Email.getText().toString().trim();
        new RaveUiManager(BookingaNyamirambo.this).setAmount(150)
                .setCurrency("RWF")
                .setEmail(email)
                .setfName(name)
                .setlName("Mahoro")
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == RaveConstants.RAVE_REQUEST_CODE && data != null) {
            ...
            if (resultCode == RavePayActivity.RESULT_SUCCESS) {
                ...
                Toast.makeText(BookingaNyamirambo.this, "Thank you for Booking", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(BookingaNyamirambo.this, ContactUsActivity.class);
