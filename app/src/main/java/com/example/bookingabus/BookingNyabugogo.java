...
public class BookingNyabugogo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(BookingNyabugogo.this,
        ...
        Time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(BookingNyabugogo.this,
                        new TimePickerDialog.OnTimeSetListener() {
                            ...
                            public void onTimeSet(TimePicker view, int hourOfDay,
                                ...
                                if((hourOfDay <= (c.get(Calendar.HOUR_OF_DAY)))&&
                                    ...
                                    Toast.makeText(BookingNyabugogo.this, "You can't pick a previous hour",
...
//                }
    ...
    private void makePayment(){
        String name = Name.getText().toString().trim();
        String email = Email.getText().toString().trim();
        new RaveUiManager(BookingNyabugogo.this).setAmount(264)
                .setCurrency("RWF")
                .setEmail(email)
                .setfName(name)
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == RaveConstants.RAVE_REQUEST_CODE && data != null) {
            ...
            if (resultCode == RavePayActivity.RESULT_SUCCESS) {
                ...
                Toast.makeText(BookingNyabugogo.this, "Thank you for Booking", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(BookingNyabugogo.this, ContactUsActivity.class);
