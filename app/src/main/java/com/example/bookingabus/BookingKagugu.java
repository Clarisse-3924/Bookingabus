...
public class BookingKagugu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(BookingKagugu.this,
        ...
        Time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(BookingKagugu.this,
                        new TimePickerDialog.OnTimeSetListener() {
                            ...
                            public void onTimeSet(TimePicker view, int hourOfDay,
                                ...
                                if((hourOfDay <= (c.get(Calendar.HOUR_OF_DAY)))&&
                                    ...
                                    Toast.makeText(BookingKagugu.this, "You can't pick a previous hour",
...
//                }
    ...
    private void makePayment(){
        String name = Name.getText().toString().trim();
        String email = Email.getText().toString().trim();
        new RaveUiManager(BookingKagugu.this).setAmount(216)
                .setCurrency("RWF")
                .setEmail(email)
                .setfName(name)
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == RaveConstants.RAVE_REQUEST_CODE && data != null) {
            ...
            if (resultCode == RavePayActivity.RESULT_SUCCESS) {
                ...
                Toast.makeText(BookingKagugu.this, "Thank you for Booking", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(BookingKagugu.this, ContactUsActivity.class);
